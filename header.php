...
<style>
/* Ensure mega menu and dropdown hover states always work */
@media (min-width: 1024px) {
    /* Force hover states to work properly */
    .main-navigation li.group:hover > .dropdown-menu,
    ...
    /* Ensure dropdown menus are directly below header with no gap */
    .dropdown-menu,
    .mega-menu {
    ...
    .main-navigation li.group {
        position: relative;
    }
    
    /* Remove any padding/margin that might create gaps */
    .site-header {
        position: relative;
        z-index: 50;
    }
