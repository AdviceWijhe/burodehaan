...
<section class="cta pt-[120px] <?php echo get_spacing_bottom_class(); ?> <?php echo isset($args['cta_type']) ? '' : 'mt-[20px]'; ?> bg-<?php echo $cta_background_color; ?> text-<?php echo $text_color; ?>! ">
    <div class="container">
        <div class="w-full lg:w-10/12 mx-auto px-0 lg:px-[65px] overflow-hidden relative">
            ...
            <div class="w-full lg:w-6/12 order-1 lg:order-2 relative mb-[24px] lg:mb-0! lg:pr-[160px]">
                <?php if (!empty($cta_titel)): ?>
                    <div class="mt-0! mb-[40px] pr-[12%]"><?php echo $cta_titel; ?></div>
                <?php endif; ?>
