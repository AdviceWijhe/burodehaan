...
>
    <button
        type="button"
        class="filter_item_label relative overflow-visible h-[59px] px-[24px] flex items-center group justify-center font-medium! gap-[8px] border border-black text-black body-small hover:cursor-pointer hover:bg-black hover:text-white"
