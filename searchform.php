...
<form role="search" method="get" class="search-form w-full max-w-[230px] lg:max-w-[420px]" action="<?php echo esc_url(home_url('/')); ?>">
    <div class="relative flex h-[59px] w-full items-stretch border border-[rgba(22,22,22,0.4)] bg-white">
        ...
        <button
            type="submit"
            class="flex h-full w-[57px] shrink-0 items-center justify-center bg-[#F7F5F0] text-[#161616] transition-colors hover:bg-[#f7f5f0] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#161616] focus-visible:ring-offset-0"
        >
