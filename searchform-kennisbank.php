...
<form role="search" method="get" class="search-form relative" action="<?php echo esc_url(home_url('/')); ?>" data-ajax-search="true" onsubmit="return handleSearchSubmit(event);">
    <div class="relative">
        ...
        <input 
            ...
            class="search-field w-full h-16 px-4 pr-12 bg-white border border-[#d6dde1] rounded-[0.25rem] text-[#092354] text-[1.0625rem] font-medium placeholder:text-[#092354] placeholder:opacity-50 focus:outline-none focus:ring-2 focus:ring-red focus:border-transparent" 
