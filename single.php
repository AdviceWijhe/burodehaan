...
<main id="main" class="site-main">
  ...
  <rect x="14.0738" y="5.92578" width="2.22222" height="2.22222" transform="rotate(90 14.0738 5.92578)" fill="#161616"/>
        ...
        <div class="post-header-image h-[12.5rem] lg:h-[40.625rem]">
            ...
            <img src="<?= esc_url($header_afbeelding['sizes']['1536x1536']); ?>" alt="<?= esc_attr($header_afbeelding['alt'] ?? ''); ?>" class="w-full h-full object-cover <?php echo esc_attr($header_image_object_class); ?>">
            <?php endif; ?>
        </div>
        <?php else : ?>
