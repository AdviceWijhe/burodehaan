...
<footer id="colophon" class="site-footer mt-auto relative overflow-hidden w-full bg-black text-white">
    ...
    <div class="w-full px-[1.25rem] lg:px-[3.75rem] py-[5rem] lg:pt-[6.25rem] lg:pb-[0rem]!">
        <?php
        ...
        >
                ...
                <div
                    class="order-2 min-w-0 lg:order-none lg:row-start-2 lg:col-start-1"
                >
                <div class="footer-accordion-item max-md:py-[1.75rem] max-md:border-b max-md:border-white/10" data-footer-accordion-item>
                    <button
                        type="button"
            ...
            <div class="order-3 min-w-0 grid grid-cols-1 gap-x-[3.125rem] gap-y-0 md:grid-cols-5 lg:order-none lg:row-start-1 lg:col-start-2 lg:items-start">
                    ...
                    >
                        ...
                        if (has_nav_menu('footer-menu-1')) {
                            wp_nav_menu(array(
                                ...
                                'container' => false,
                                'menu_class' => 'space-y-[1.5rem] list-medium text-white/70 font-light [&_*]:font-light!',
                                'fallback_cb' => false,
                            ));
                        }
                        ?>
                        ...
                        <?php foreach ($locations as $location) : ?>
                            ...
                            <div class="mb-8 md:mb-0 last:mb-0 col-span-1 md:col-span-2">
                                ...
                                <?php if (!empty($location_phone)) : ?>
                                    <a class="block text-white hover:text-primary transition-colors mb-4 body-medium font-medium! flex items-center gap-3" href="<?php echo esc_url('tel:' . preg_replace('/\s+/', '', $location_phone)); ?>">
  ...
  <path d="M5.47656 8.24219L8.125 5.625L5 0L0 2.5V3.125C0 12.4453 7.55469 20 16.875 20H17.5L20 15L14.375 11.875L11.7578 14.5234C9.00391 13.2148 6.78516 10.9961 5.47656 8.24219ZM14.4844 12.6523L19.1719 15.2578L17.1133 19.3789H16.875C7.90234 19.375 0.625 12.1016 0.625 3.125V2.88672L4.74219 0.828125L7.34766 5.51562L5.03516 7.80078L4.71875 8.11328L4.91016 8.51562C6.28125 11.3984 8.60156 13.7227 11.4844 15.0898L11.8867 15.2812L12.1992 14.9648L14.4844 12.6523Z" fill="white"/>
                                ...
                                <?php if (!empty($location_email)) : ?>
                                    <a class="block text-white hover:text-primary transition-colors body-medium font-medium! flex items-center gap-3" href="<?php echo esc_url('mailto:' . $location_email); ?>">
  ...
  <path d="M0 0H20V15H0V0ZM19.375 0.625H0.625V2.66016L10 9.91797L19.375 2.66016V0.625ZM0.625 3.44922V14.375H19.375V3.44922L10.1914 10.5586L10 10.707L9.80859 10.5586L0.625 3.44922Z" fill="white"/>
        ...
        <div class="mt-[5rem] lg:mt-[8.75rem] grid grid-cols-1 lg:grid-cols-12 gap-[2.5rem] relative flex flex-col lg:flex-row lg:items-center gap-y-8">
            <div class="flex w-full min-w-0 items-center justify-center lg:justify-start gap-4 col-span-1 lg:col-span-5">
                <?php if (!empty($socials) && is_array($socials)) : ?>
                    <?php foreach ($socials as $social) : ?>
                        ...
                        <a
                            ...
                            rel="noopener"
                            class="group inline-flex h-15 w-15 items-center justify-center border border-white/12 transition-colors hover:border-white/25"
                        >
                            <?php
                            if (is_numeric($social_icon)) {
                                echo wp_get_attachment_image((int) $social_icon, 'full', false, array('class' => 'h-4 w-4 object-contain transition-transform duration-200 ease-out group-hover:scale-110'));
                            } elseif (is_array($social_icon) && !empty($social_icon['url'])) {
                                ?>
                                <img class="h-5 w-5 object-contain transition-transform duration-200 ease-out group-hover:scale-110" src="<?php echo esc_url($social_icon['url']); ?>" alt="<?php echo esc_attr($social_icon['alt'] ?? ''); ?>">
                                <?php
                            }
                            ?>
                        </a>
        ...
        >
            ...
            >
                ...
                <a
                    href="https://advice.nl"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Ga naar Advice.nl"
                    class="footer-credits__logo inline-flex shrink-0 items-baseline m-0! !leading-none !text-white !font-normal !no-underline transition-opacity hover:opacity-80"
                >
                <svg
                    class="relative top-[2px] block h-[0.875rem] w-auto shrink-0 max-sm:max-w-[min(100%,12.5rem)]"
  ...
  <path d="M122.058 10.9283V3.0422H123.476V10.9283H122.058ZM120.848 4.16457V3.0422H123.476V4.16457H120.848ZM122.457 1.77216C122.142 1.77216 121.906 1.68847 121.748 1.5211C121.601 1.35373 121.527 1.14206 121.527 0.886079C121.527 0.6301 121.601 0.418426 121.748 0.251055C121.906 0.083685 122.142 0 122.457 0C122.772 0 123.004 0.083685 123.151 0.251055C123.309 0.418426 123.388 0.6301 123.388 0.886079C123.388 1.14206 123.309 1.35373 123.151 1.5211C123.004 1.68847 122.772 1.77216 122.457 1.77216Z" fill="white"/>
